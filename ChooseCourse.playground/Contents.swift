...
while 继续循环{
    ...
    if 第一课程 != 第二课程 &&
        ...
        第四课程 != 第一课程 && 第四课程 != 第二课程 && 第四课程 != 第三课程{
            ...
            //判断课程依赖是否符合条件
            if 课程组[第一课程].要求先修微积分或线性代数  ||
                课程组[第二课程].要求先修微积分或线性代数 ||
                课程组[第三课程].要求先修微积分或线性代数 ||
                课程组[第四课程].要求先修微积分或线性代数 {
                if  课程组[第一课程].课程名称 != "微积分" && 课程组[第一课程].课程名称 != "线性代数" &&
                    课程组[第二课程].课程名称 != "微积分" && 课程组[第一课程].课程名称 != "线性代数" &&
                    课程组[第三课程].课程名称 != "微积分" && 课程组[第三课程].课程名称 != "线性代数" &&
...
while 继续循环{
    ...
    if 第一课程 != 第二课程 &&
        第二课程 != 第三课程 && 第三课程 != 第一课程 &&
        第四课程 != 第一课程 && 第四课程 != 第二课程 && 第四课程 != 第三课程 &&
        第五课程 != 第一课程 && 第五课程 != 第二课程 && 第五课程 != 第三课程 && 第五课程 != 第四课程{
...
while 继续循环{
    ...
    if 第一课程 != 第二课程 &&
        ...
        第四课程 != 第一课程 && 第四课程 != 第二课程 && 第四课程 != 第三课程 &&
        第五课程 != 第一课程 && 第五课程 != 第二课程 && 第五课程 != 第三课程 && 第五课程 != 第四课程 &&
        第六课程 != 第一课程 && 第六课程 != 第二课程 && 第六课程 != 第三课程 && 第六课程 != 第四课程 && 第六课程 != 第五课程{
            ...
            if 课程组[第一课程].要求先修微积分或线性代数  ||
                ...
                课程组[第四课程].要求先修微积分或线性代数 ||
                课程组[第五课程].要求先修微积分或线性代数 ||
                课程组[第六课程].要求先修微积分或线性代数{
                if 课程组[第一课程].课程名称 != "微积分" && 课程组[第一课程].课程名称 != "线性代数" &&
                    课程组[第二课程].课程名称 != "微积分" && 课程组[第一课程].课程名称 != "线性代数" &&
                    课程组[第三课程].课程名称 != "微积分" && 课程组[第三课程].课程名称 != "线性代数" &&
                    课程组[第四课程].课程名称 != "微积分" && 课程组[第四课程].课程名称 != "线性代数" &&
                    课程组[第五课程].课程名称 != "微积分" && 课程组[第五课程].课程名称 != "线性代数" &&
                    课程组[第六课程].课程名称 != "微积分" && 课程组[第六课程].课程名称 != "线性代数"{
                        符合条件 = false
                }
            }
            if 课程组[第一课程].要求先修应用统计 || 课程组[第二课程].要求先修应用统计 || 课程组[第三课程].要求先修应用统计 || 课程组[第四课程].要求先修应用统计 || 课程组[第五课程].要求先修应用统计{
            ...
            if 符合条件 {
                可选个数++
                var 学分:Int = 课程组[第一课程].学分! + 课程组[第二课程].学分! + 课程组[第三课程].学分! + 课程组[第四课程].学分! + 课程组[第五课程].学分!
                print("选六门课：选择\n\(课程组[第一课程].课程名称)，\(课程组[第二课程].课程名称)，\(课程组[第三课程].课程名称)，\(课程组[第四课程].课程名称)，\(课程组[第五课程].课程名称)，\(课程组[第六课程].课程名称)\n可以满足条件，学分为 \(学分)\n")
                if 学分 > 最高学分{
                    最高学分 = 学分
                    print("出现新最高学分！分值：\(最高学分)")
                }
